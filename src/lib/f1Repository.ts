...
export const getStatuses = () => readTable<{ id: string; status_text?: string }>('status')
export const getResults = () => readTable<{ id: string; race_id: string; driver_id: string; team_id?: string; grid?: number; position?: number; points?: number; laps?: number; status_id?: string; fastest_lap_rank?: number; fastest_lap_time?: string }>('results')
...
export const getDriverStandings = () => readTable<{ id: string; season_id: string; race_id?: string; driver_id: string; position?: number; wins?: number }>('driver_standings')
