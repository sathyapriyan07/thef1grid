...
import { getDriverPodiums, getDrivers, getRaces, getResults, getSeasons, getTeams } from '../lib/f1Repository'
...
export default function EntityDetail({ kind }: { kind: 'driver' | 'team' }) {
  ...
  if (drivers.isLoading || teams.isLoading || races.isLoading || seasons.isLoading || results.isLoading || podiums.isLoading) return <section className="empty-state"><strong>Loading imported relationships...</strong></section>
